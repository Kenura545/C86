...
var length_of_name_of_staudent_array = name_of_student_array.length;
console.log(length_of_name_of_staudent_array)

for (var k = 0; k < length_of_name_of_staudent_array; k++) 
{
